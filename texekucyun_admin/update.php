	...
	<div class="main">
		...
		<div class="container">	 
		   ...
		   <label for="nkar">nkar</label><br>
			   ...
			   <textarea name="nkar" id="nkar" rows="3" cols="60"><?php echo $r['nkar'];?> </textarea> <br><br>
			   <label for="vernagir">vernagir</label><br>
				   <textarea name="vernagir" id="vernagir" rows="5" cols="60"><?php echo $r['vernagir'];?> </textarea> <br><br>
				   <label for="text">text</label><br>
				   <textarea name="text" id="text" rows="5" cols="60"><?php echo $r['text'];?></textarea> <br><br>
				   <label for="vernagir2">vernagir2</label><br>
				   <textarea name="vernagir2" id="vernagir2" rows="5" cols="60"><?php echo $r['vernagir2'];?></textarea> <br><br>
